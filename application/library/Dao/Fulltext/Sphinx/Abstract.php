<?php
abstract class Dao_Fulltext_Sphinx_Abstract extends Dao_Abstract {
	...
	/**
	 * @var Shelby_Dao_Mongodb_List_Abstract
	 */
	 ...
	 * 
	 * @param array $matches
	 * @return Shelby_Dao_Result_Mongodb_List
	 */
	...
	public function search($query, $results, $page, Array $search) {
		return new Shelby_Dao_Result_Mongodb_Sphinx_List($this, $query, $results, $page, $search);
	}
	...
	protected function _connect() {
		if (is_null($this->_sphinx_obj)) {
			...
			$this->_sphinx_obj->setServer(self::$_options['host'], self::$_options['port']);
			$this->_sphinx_obj->setMaxQueryTime(self::$_options['max_query_time']);
